# Generated by Powerlevel10k configuration wizard on 2024-01-27 at 11:20 EST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 04117.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, round separators, blurred heads, round tails, 2 lines, solid, full frame,
# light-ornaments, compact, many icons, fluent, transient_prompt, instant_prompt=off.
