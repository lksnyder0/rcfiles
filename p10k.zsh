# Generated by Powerlevel10k configuration wizard on 2023-10-10 at 10:39 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    my_aws_vault     # Show aws-vault profile
    # =========================[ Line #2 ]=========================
    newline                 # \n
  ...
  function prompt_example() {
    example_text="hellooo, $USER"
    p10k segment -f 208 -i '⭐' -t $example_text
  }
...
function prompt_my_aws_vault() {
  if [[ $AWS_VAULT != '' ]]; then
    profile="$AWS_VAULT"
    p10k segment -s login -f "#000000" -i '☁️' -t $profile
  fi
}

typeset -g POWERLEVEL9K_MY_AWS_VAULT_LOGIN_BACKGROUND="#FF9900"

function instant_prompt_my_aws_vault() {
  prompt_my_aws_vault
}
