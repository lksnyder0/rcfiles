...
alias cco="cc --model claude-opus-5"
alias ccs="cc --model claude-sonnet-5"
alias ccf="cc --model claude-fable-5"
alias cch="cc --model claude-haiku-4-5-20251001"
alias w="wt list"
alias ws="wt switch"
